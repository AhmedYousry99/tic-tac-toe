...
public class BoardSinglePlayerBase extends AnchorPane {
    ...
    public BoardSinglePlayerBase() {
        ...
        backgroundImage.setFitHeight(1083.0);
        backgroundImage.setFitWidth(1928.0);
        ...
        player1NameText.setLayoutX(37.0);
        player1NameText.setLayoutY(150.0);
        ...
        player1NameText.setFont(new Font("Agency FB", 130.0));

        player1WinsText.setFill(javafx.scene.paint.Color.WHITE);
        player1WinsText.setLayoutX(79.0);
        player1WinsText.setLayoutY(262.0);
        ...
        player1WinsText.setFont(new Font("Agency FB", 80.0));

        player2NameText.setFill(javafx.scene.paint.Color.WHITE);
        player2NameText.setLayoutX(1580.0);
        player2NameText.setLayoutY(145.0);
        ...
        player2NameText.setFont(new Font("Agency FB", 130.0));

        player2WinsText.setFill(javafx.scene.paint.Color.WHITE);
        player2WinsText.setLayoutX(1622.0);
        player2WinsText.setLayoutY(257.0);
        ...
        player2WinsText.setFont(new Font("Agency FB", 80.0));

        roundNumberText.setFill(javafx.scene.paint.Color.WHITE);
        roundNumberText.setLayoutX(847.0);
        roundNumberText.setLayoutY(128.0);
        ...
        roundNumberText.setFont(new Font("Agency FB", 96.0));

        modeText.setFill(javafx.scene.paint.Color.WHITE);
        modeText.setLayoutX(718.0);
        modeText.setLayoutY(1004.0);
        ...
        btnLeave.setLayoutX(25.0);
        btnLeave.setLayoutY(971.0);
        ...
        btnRematch.setLayoutX(1694.0);
        btnRematch.setLayoutY(968.0);
